...
public class Formulario_Cadastro_Samsung {
...
static WebDriver driver; 
	...
	GetCPF cpf = new GetCPF();
		...
		public void PrimeiroCadastro() throws InterruptedException {
			...
			login.TypeUsernameBoletaSams();
			login.TypePasswordBoletaSams();
			login.clickOnLoginButtonBoletaSams();
		  ...
		  //    driver.findElement(By.id("municipio")).sendKeys("Curitiba");		
			    ...
			    driver.findElement(By.cssSelector("input[formControlName='nome']")).sendKeys("Luke Legal");
			    driver.findElement(By.id("emailRepresentante-0")).sendKeys("l@gmail.com");
			    driver.findElement(By.id("cpfRepresentante-0")).sendKeys("62551208211");
	...
	//		    driver.findElement(By.id("dtNascimentoRepresentante-1")).sendKeys("09031988");
			    ...
			    driver.findElement(By.id("cpfUsuario-0")).sendKeys("67721065984");
			    ...
			    driver.findElement(By.id("cpfUsuario-1")).sendKeys("19225572425");
